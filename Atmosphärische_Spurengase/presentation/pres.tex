...
\title{Atmosphärische Spurenstoffe}
	...
	\begin{columns}
	  \column{0.5\textwidth}
	  	\begin{figure}
    		...
    		\caption{$\Delta \text{SCD}$ von \ch{NO2} über den Tag des 24.04.2019}
    		\label{fig:delta_SCD_time_NO2}
        \end{figure}
      \column{0.5\textwidth}
    	\begin{figure}
    		\includegraphics[width=1.2\linewidth]{fig/SCD_Time_Plot_O3.pdf}
    		\caption{$\Delta \text{SCD}$ von \ch{O3} über den Tag des 24.04.2019}
...
\begin{frame}
    ...
    \begin{figure}
		...
		\caption{vertical column density Tagesmessung \ch{O3}}    
	\end{figure}
\end{frame}

\begin{frame}
	 \frametitle{Vertical Column Density \ch{O3} von NASA Messungen}
	 \begin{figure}	
    	\includegraphics[width=0.7\linewidth]{fig/DOAS_VCD_Ozone_ohne_Maus.png}
    \end{figure}
    \begin{figure}
    	\includegraphics[width=0.7\linewidth]{fig/TOMS_VCD_Ozone_ohne_Maus.png}
    \end{figure}
