...
\begin{frame}
    ...
    \vspace{-1cm}
		\begin{figure}
        	\includegraphics[width=.8\textwidth]{fig/fit_O3.png}
...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width=\linewidth]{fig/fit_NO2.png}
		\caption{Fitanpassung \ch{NO2}-Messung}
	\end{figure}
