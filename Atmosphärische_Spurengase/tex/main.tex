...
Zu Beginn wurde durch Variieren der Messzeit (\textit{exposure time}) und der Anzahl der Scans (\textit{exposures}) ein erster Überblick über das Programm DOASIS verschafft.
...
\begin{align}
	\rho_{\ch{NO2}} = (2.48 \pm 0.12) \cdot 10^{20} [\frac{\text{molecules}}{\si{liter}}]
\end{align}
