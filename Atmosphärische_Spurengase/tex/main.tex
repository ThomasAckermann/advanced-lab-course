...
Die Lösung hier besteht daraus das Spektrum mit verschiedenen Winkeln aufzunehmen und dann zu vergleichen.
...
Wenn nun die Messungen vom Morgen im Langley-Plot vorhanden wären, könnte keine Gerade mehr eindeutig festgemacht werden.
...
\begin{center}
    ...
    \captionof{figure}{DOAS VCD Messung mit Satelit aufgenommen} %\footnote{\href{https://disc.gsfc.nasa.gov/datasets/OMDOAO3G_V003/summary}}}
	\label{fig:DOAS_satelit}
\end{center} 

\begin{center}
	\includegraphics[width=\linewidth]{fig/TOMS_VCD_Ozone_ohne_Maus.png}
    \captionof{figure}{TOMS VCD Messung mit Satelit aufgenommen}% \footnote{\href{https://disc.gsfc.nasa.gov/datasets/TOMSEPL3_V008/summary}}}
...
Das Teleskop hatte hier einen SZA von $80^\circ$, was dafür sorgt, dass hauptsächlich die stratosphärischen Konzentrationen aufgenommen wurden.
...
Anschließend wurden Langley-Plots erstellt, mithilfe derer man die VCD bestimmen kann, wenn die Langley-Plots linear sind.
Dies war für \ch{O3} der Fall.
Es zeigte sich, dass das VCA von \ch{O3} bei ca. 300\si{DU} lag.
Der Wert wurde mit Satelitenbildern verglichen, wobei sich zeigte, dass die Werte der Sateliten beide um ca 50 \si{DU} höher lagen.
Grund hierfür war, dass in der Messung hier die troposphärische Konzentration nicht berücksichtigt wurde.\\

Im letzten Versuchtsteil wurden jeweils vier Messungen bei $7^\circ$ und $12^\circ$ zwischen Kamera und Erde durchgeführt.
...
Allerdings lässt sich die Tendenz erahnen, dass \ch{O3} eher in der Troposphäre auftritt.
