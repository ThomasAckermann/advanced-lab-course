...
In Abbildung \ref{fig:delta_SCD_time_NO2} ist zu erkennen, dass $\Delta$SCD \ch{NO2} zunächst niedrig ist, zum Abend in jedoch stark zunimmt.
Grund dafür sind chemische Prozesse die Unterschiedlich stark bei verschiedner Sonneneinstrahlungen stattfinden.
...
Bei \ch{O3} in Abbildung \ref{fig:delta_SCD_time_O3} ist ein ähnliches verhalten zu beobachten.
