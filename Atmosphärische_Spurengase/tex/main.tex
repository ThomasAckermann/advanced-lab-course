...
The main goal was to find the column density (CD) of \ch{NO2} and \ch{O3} in the atmosphere by using the \textit{Differential Optical Absorption Spectroscopy} (DOAS) method. \\
...
One arrived at a vertical column density of $\sim 300 \si{DU}$ for \ch{O3}, which is an underestimation when compared with data recorded by NASA (measured $\sim 350 \si{DU}$).\\ 
By varying the elevation angle of the telescope and comparing the results 
one can analyze the tropospheric and stratospheric profile of \ch{O3}, \ch{O4} and \ch{NO2}.
...
\ch{O4} entsteht bei der Kollision von \ch{O2}.
Da die Dichte mit zunehmender Höhe exponentiell abnimmt, nimmt auch die Menge des \ch{O4} exponentiell ab.
