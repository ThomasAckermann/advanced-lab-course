...
int main(int argc, char *argv[])
{
	...
	ImageType::Pointer fixedImage = nrnLoadImage<ImageType>
		("C:/FP/Allgemein/Daten/patient_105/ct/patient_105_ct.mhd");
	ImageType::Pointer movingImage = nrnLoadImage<ImageType>
		("C:/FP/Allgemein/Daten/patient_105/mr_T2/patient_105_mr_T2.mhd");
	...
	unsigned int numberOfLevels = 10;
	shrinkFactorsPerLevel.SetSize(numberOfLevels);
	shrinkFactorsPerLevel[0] = 4;
	shrinkFactorsPerLevel[1] = 3.75;
	shrinkFactorsPerLevel[2] = 3.5;
	shrinkFactorsPerLevel[3] = 3.25;
	shrinkFactorsPerLevel[4] = 3;
	shrinkFactorsPerLevel[5] = 2.5;
	shrinkFactorsPerLevel[6] = 2;
	shrinkFactorsPerLevel[7] = 1.75;
	shrinkFactorsPerLevel[8] = 1.25;
	shrinkFactorsPerLevel[9] = 1;



	smoothingSigmasPerLevel.SetSize(numberOfLevels);
	smoothingSigmasPerLevel[0] = 10;
	smoothingSigmasPerLevel[1] = 9.5;
	smoothingSigmasPerLevel[2] = 9;
	smoothingSigmasPerLevel[3] = 8;
	smoothingSigmasPerLevel[4] = 7;
	smoothingSigmasPerLevel[5] = 5;
	smoothingSigmasPerLevel[6] = 3;
	smoothingSigmasPerLevel[7] = 2;
	smoothingSigmasPerLevel[8] = 1;
	smoothingSigmasPerLevel[9] = 0;
  ...
  nrnSaveImage<ImageType>("output.mhd", resampledImage);
