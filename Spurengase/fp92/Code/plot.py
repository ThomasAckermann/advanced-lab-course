...
styleHisto(h_e, ROOT.kBlack, "M_{ll} [GeV]", "Entries")
styleHisto(h_m, ROOT.kBlack, "M_{ll} [GeV]", "Entries")
styleHisto(h_t, ROOT.kBlack, "M_{ll} [GeV]", "Entries")
legend.AddEntry(h_d, "Data", "lep")
legend.AddEntry(h_e, "Z #rightarrow ee", "f")
legend.AddEntry(h_m, "Z #rightarrow #mu#mu", "f")
legend.AddEntry(h_t, "Z #rightarrow #tau#tau", "f")
h_e.SetFillColor(ROOT.kBlue-3)
h_m.SetFillColor(ROOT.kGreen-3)
h_t.SetFillColor(ROOT.kRed-3)
...
h_d.Draw("same")
h_d.GetXaxis().SetRange(55,95)
# h_e.GetXaxis().SetRange(70,115)
# h_m.GetXaxis().SetRange(70,115)
# h_t.GetXaxis().SetRange(70,115)
